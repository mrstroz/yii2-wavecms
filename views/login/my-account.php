...
<div class="row">
    ...
    <div class="col-md-6">
        <?php PanelWidget::begin(['heading' => Yii::t('wavecms/user','Change password'), 'panel_class' => 'panel-primary']); ?>

        <div class="alert alert-info">
            <?php echo FontAwesome::icon('info-circle'); ?>
            <?php echo Yii::t('wavecms/user','Leave empty fields if you don\'t want to change password'); ?>
        </div>
...
<?php echo Html::submitButton(Yii::t('wavecms/user','Save changes'), ['class' => 'btn btn-primary']); ?>
